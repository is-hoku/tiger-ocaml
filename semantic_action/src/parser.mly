...
tyfields:
| ID COLON ID tyfield { {name = Syntax.Sym (Symbol.from_string $1); escape = ref false; typ = Syntax.Sym (Symbol.from_string $3); pos = Parsing.rhs_end_pos 1} :: $4 }
| { [] }
/* error */
| ID error ID tyfield { let pos = Parsing.rhs_end_pos 2 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); {name = Syntax.Sym (Symbol.from_string $1); escape = ref false; typ = Syntax.Sym (Symbol.from_string $3); pos = Parsing.rhs_end_pos 1} :: $4 }
| ID COLON error tyfield { let pos = Parsing.rhs_end_pos 3 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); {name = Syntax.Sym (Symbol.from_string $1); escape = ref false; typ = Syntax.ErrorSym; pos = Parsing.rhs_end_pos 1} :: $4 }

tyfield:
| COMMA ID COLON ID tyfield { {name = Syntax.Sym (Symbol.from_string $2); escape = ref false; typ = Syntax.Sym (Symbol.from_string $4); pos = Parsing.rhs_end_pos 2} :: $5 }
| { [] }
/* error */
| COMMA error COLON ID tyfield { let pos = Parsing.rhs_end_pos 2 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); {name = Syntax.ErrorSym; escape = ref false; typ = Syntax.Sym (Symbol.from_string $4); pos = Parsing.rhs_end_pos 2} :: $5 }
| COMMA ID error ID tyfield { let pos = Parsing.rhs_end_pos 3 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); {name = Syntax.Sym (Symbol.from_string $2); escape = ref false; typ = Syntax.Sym (Symbol.from_string $4); pos = Parsing.rhs_end_pos 2} :: $5 }
| COMMA ID COLON error tyfield { let pos = Parsing.rhs_end_pos 4 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); {name = Syntax.Sym (Symbol.from_string $2); escape = ref false; typ = Syntax.ErrorSym; pos = Parsing.rhs_end_pos 2} :: $5 }

vardec:
| VAR ID ASSIGN exp { Syntax.VarDec {name = Syntax.Sym (Symbol.from_string $2); escape = ref false; typ = None; init = $4; pos = Parsing.rhs_end_pos 1} }
| VAR ID COLON ID ASSIGN exp { Syntax.VarDec {name = Syntax.Sym (Symbol.from_string $2); escape = ref false; typ = Some ((Syntax.Sym (Symbol.from_string $4)), (Parsing.rhs_end_pos 4)); init = $6; pos = Parsing.rhs_end_pos 1} }
/* error */
| VAR error ASSIGN exp { let pos = Parsing.rhs_end_pos 2 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.VarDec {name = Syntax.ErrorSym; escape = ref false; typ = None; init = $4; pos = Parsing.rhs_end_pos 1} }
| VAR ID error exp { let pos = Parsing.rhs_end_pos 3 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.VarDec {name = Syntax.Sym (Symbol.from_string $2); escape = ref false; typ = None; init = $4; pos = Parsing.rhs_end_pos 1}}
| VAR error COLON ID ASSIGN exp { let pos = Parsing.rhs_end_pos 2 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.VarDec {name = Syntax.ErrorSym; escape = ref false; typ = Some ((Syntax.Sym (Symbol.from_string $4)), (Parsing.rhs_end_pos 4)); init = $6; pos = Parsing.rhs_end_pos 1} }
| VAR ID error ID ASSIGN exp { let pos = Parsing.rhs_end_pos 3 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.VarDec {name = Syntax.Sym (Symbol.from_string $2); escape = ref false; typ = Some ((Syntax.Sym (Symbol.from_string $4)), (Parsing.rhs_end_pos 4)); init = $6; pos = Parsing.rhs_end_pos 1} }
| VAR ID COLON error ASSIGN exp { let pos = Parsing.rhs_end_pos 4 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.VarDec {name = Syntax.Sym (Symbol.from_string $2); escape = ref false; typ = Some (Syntax.ErrorSym, (Parsing.rhs_end_pos 4)); init = $6; pos = Parsing.rhs_end_pos 1} }
...
| FOR ID ASSIGN exp TO exp DO exp { Syntax.ForExp {var = Syntax.Sym (Symbol.from_string $2); escape = ref false; lo = $4; hi = $6; body = $8; pos = Parsing.rhs_end_pos 1} }
...
| FOR error ASSIGN exp TO exp DO exp { let pos = Parsing.rhs_end_pos 2 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.ForExp {var = Syntax.ErrorSym; escape = ref false; lo = $4; hi = $6; body = $8; pos = Parsing.rhs_end_pos 1} }
| FOR ID error exp TO exp DO exp { let pos = Parsing.rhs_end_pos 3 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.ForExp {var = Syntax.Sym (Symbol.from_string $2); escape = ref false; lo = $4; hi = $6; body = $8; pos = Parsing.rhs_end_pos 1} }
| FOR ID ASSIGN error TO exp DO exp { let pos = Parsing.rhs_end_pos 4 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.ForExp {var = Syntax.Sym (Symbol.from_string $2); escape = ref false; lo = Syntax.ErrorExp ; hi = $6; body = $8; pos = Parsing.rhs_end_pos 1} }
...
| FOR ID ASSIGN exp TO error DO exp { let pos = Parsing.rhs_end_pos 6 in Printf.fprintf stdout "SyntaxError: invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.ForExp {var = Syntax.Sym (Symbol.from_string $2); escape = ref false; lo = $4; hi = Syntax.ErrorExp ; body = $8; pos = Parsing.rhs_end_pos 1} }
