...
/* error */
| lvalue LBRACK error RBRACK { let pos = Parsing.rhs_end_pos 3 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.SubscriptVar ($1, Syntax.ErrorExp (Parsing.rhs_end_pos 3), Parsing.rhs_end_pos 1) }
| ID LBRACK error RBRACK { let pos = Parsing.rhs_end_pos 3 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.SubscriptVar (Syntax.SimpleVar (Syntax.Sym (Symbol.from_string $1), Parsing.rhs_end_pos 1), Syntax.ErrorExp (Parsing.rhs_end_pos 3), Parsing.rhs_end_pos 1) }
...
| IF error THEN exp ELSE exp { let pos = Parsing.rhs_end_pos 2 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.IfExp {test = Syntax.ErrorExp (Parsing.rhs_end_pos 2); then' = $4; else' = Some $6; pos = Parsing.rhs_end_pos 1} }
...
| IF exp THEN error ELSE exp { let pos = Parsing.rhs_end_pos 4 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.IfExp {test = $2; then' = Syntax.ErrorExp (Parsing.rhs_end_pos 4); else' = Some $6; pos = Parsing.rhs_end_pos 1} }
| IF error THEN exp { let pos = Parsing.rhs_end_pos 2 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.IfExp {test = Syntax.ErrorExp (Parsing.rhs_end_pos 2); then' = $4; else' = None; pos = Parsing.rhs_end_pos 1} }
| WHILE error DO exp { let pos = Parsing.rhs_end_pos 2 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.WhileExp {test = Syntax.ErrorExp (Parsing.rhs_end_pos 2); body = $4; pos = Parsing.rhs_end_pos 1} }
...
| FOR ID ASSIGN error TO exp DO exp { let pos = Parsing.rhs_end_pos 4 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.ForExp {var = Syntax.Sym (Symbol.from_string $2); escape = ref true; lo = Syntax.ErrorExp (Parsing.rhs_end_pos 4); hi = $6; body = $8; pos = Parsing.rhs_end_pos 1} }
...
| FOR ID ASSIGN exp TO error DO exp { let pos = Parsing.rhs_end_pos 6 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.ForExp {var = Syntax.Sym (Symbol.from_string $2); escape = ref true; lo = $4; hi = Syntax.ErrorExp (Parsing.rhs_end_pos 6); body = $8; pos = Parsing.rhs_end_pos 1} }
| LET decs IN error END { let pos = Parsing.rhs_end_pos 4 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); Syntax.LetExp {decs = $2; body = Syntax.ErrorExp (Parsing.rhs_end_pos 4); pos = Parsing.rhs_end_pos 1} }
...
| ID EQ error field { let pos = Parsing.rhs_end_pos 3 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); (Syntax.Sym (Symbol.from_string $1), Syntax.ErrorExp (Parsing.rhs_end_pos 3), Parsing.rhs_end_pos 1) :: $4 }
...
| COMMA ID EQ error field { let pos = Parsing.rhs_end_pos 4 in Printf.fprintf stdout "invalid syntax in line %d at character %d\n" pos.pos_lnum (pos.pos_cnum - pos.pos_bol); (Syntax.Sym (Symbol.from_string $2), Syntax.ErrorExp (Parsing.rhs_end_pos 4), Parsing.rhs_end_pos 2) :: $5 }
